...
[![dsh](https://img.shields.io/badge/DSH%200.1.5--rc.1%20%2F%20rc.2%20%2F%200.1.6--alpha.2-7aa2f7)](https://github.com/deepseek-ai/dsh)
...
> **兼容性 / Compatibility**：v0.1.6 支持 DSH **≥0.1.5-rc.1**，已在 **0.1.5-rc.1 / 0.1.5-rc.2 / 0.1.6-alpha.2** 实测（RPC envelope 探针全过）；旧版 DSH（0.1.0-rc.5 ~ rc.8）请使用最后兼容的 npm 版本 **0.1.5**。
> v0.1.6 targets DSH **≥0.1.5-rc.1**, verified on **0.1.5-rc.1 / 0.1.5-rc.2 / 0.1.6-alpha.2**; for older DSH releases use the last compatible npm version **0.1.5**.
