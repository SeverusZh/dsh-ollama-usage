...
[![dsh](https://img.shields.io/badge/dsh-%E2%89%A50.1.2--rc.1-7aa2f7)](https://github.com/deepseek-ai/dsh)
...
> **兼容性 / Compatibility**：v0.1.6 支持 DSH **≥0.1.2-alpha.4**，已在当前运行时 **0.1.2-rc.1** 实测（RPC envelope 探针全过）；旧版 DSH（0.1.0-rc.5 ~ rc.8）请使用最后兼容的 npm 版本 **0.1.5**。
> v0.1.6 targets DSH **≥0.1.2-alpha.4**, verified on the current runtime **0.1.2-rc.1**; for older DSH releases use the last compatible npm version **0.1.5**.
